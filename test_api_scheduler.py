...
import scheduler  # import your main scheduler.py file
...
class TestSchedulerFunctions(unittest.TestCase):
    ...
    def test_parse_timestamps_valid(self):
        ...
        result = scheduler.parse_timestamps(timestamps, suppress_print=True)
    ...
    def test_group_by_time(self):
        ...
        grouped = scheduler.group_by_time(times)
    ...
    def test_wait_until_future_seconds(self):
        ...
        start = datetime.now()
        scheduler.wait_until(future_time)  # Will actually wait ~2 seconds
        end = datetime.now()
